...
pub const struct_sqlite3_vfs = extern struct {
    ...
    xOpen: ?*const fn ([*c]sqlite3_vfs, [*c]const u8, [*c]sqlite3_file, c_int, [*c]c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]sqlite3_vfs, [*c]const u8, [*c]sqlite3_file, c_int, [*c]c_int) callconv(.C) c_int),
...
pub const SQLITE_VERSION = "3.37.2";
pub const SQLITE_VERSION_NUMBER = @import("std").zig.c_translation.promoteIntLiteral(c_int, 3037002, .decimal);
pub const SQLITE_SOURCE_ID = "2022-01-06 13:25:41 872ba256cbf61d9290b571c0e6d82a20c224ca3ad82971edc46b29818d5dalt1";
