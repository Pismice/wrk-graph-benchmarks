...
pub const struct_sqlite3_api_routines = extern struct {
    aggregate_context: ?*const fn (?*sqlite3_context, c_int) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, c_int) callconv(.C) ?*anyopaque),
    aggregate_count: ?*const fn (?*sqlite3_context) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_context) callconv(.C) c_int),
    bind_blob: ?*const fn (?*sqlite3_stmt, c_int, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int),
    bind_double: ?*const fn (?*sqlite3_stmt, c_int, f64) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, f64) callconv(.C) c_int),
    bind_int: ?*const fn (?*sqlite3_stmt, c_int, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, c_int) callconv(.C) c_int),
    bind_int64: ?*const fn (?*sqlite3_stmt, c_int, sqlite_int64) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, sqlite_int64) callconv(.C) c_int),
    bind_null: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int),
    bind_parameter_count: ?*const fn (?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) c_int),
    bind_parameter_index: ?*const fn (?*sqlite3_stmt, [*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, [*c]const u8) callconv(.C) c_int),
    bind_parameter_name: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8),
    bind_text: ?*const fn (?*sqlite3_stmt, c_int, [*c]const u8, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, [*c]const u8, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int),
    bind_text16: ?*const fn (?*sqlite3_stmt, c_int, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int),
    bind_value: ?*const fn (?*sqlite3_stmt, c_int, ?*const sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, ?*const sqlite3_value) callconv(.C) c_int),
    busy_handler: ?*const fn (?*sqlite3, ?*const fn (?*anyopaque, c_int) callconv(.C) c_int, ?*anyopaque) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const fn (?*anyopaque, c_int) callconv(.C) c_int, ?*anyopaque) callconv(.C) c_int),
    busy_timeout: ?*const fn (?*sqlite3, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, c_int) callconv(.C) c_int),
    changes: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    close: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    collation_needed: ?*const fn (?*sqlite3, ?*anyopaque, ?*const fn (?*anyopaque, ?*sqlite3, c_int, [*c]const u8) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*anyopaque, ?*const fn (?*anyopaque, ?*sqlite3, c_int, [*c]const u8) callconv(.C) void) callconv(.C) c_int),
    collation_needed16: ?*const fn (?*sqlite3, ?*anyopaque, ?*const fn (?*anyopaque, ?*sqlite3, c_int, ?*const anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*anyopaque, ?*const fn (?*anyopaque, ?*sqlite3, c_int, ?*const anyopaque) callconv(.C) void) callconv(.C) c_int),
    column_blob: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque),
    column_bytes: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int),
    column_bytes16: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int),
    column_count: ?*const fn (?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) c_int),
    column_database_name: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8),
    column_database_name16: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque),
    column_decltype: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8),
    column_decltype16: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque),
    column_double: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) f64 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) f64),
    column_int: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int),
    column_int64: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) sqlite_int64 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) sqlite_int64),
    column_name: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8),
    column_name16: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque),
    column_origin_name: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8),
    column_origin_name16: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque),
    column_table_name: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8),
    column_table_name16: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque),
    column_text: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) [*c]const u8),
    column_text16: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*const anyopaque),
    column_type: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int),
    column_value: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*sqlite3_value = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) ?*sqlite3_value),
    commit_hook: ?*const fn (?*sqlite3, ?*const fn (?*anyopaque) callconv(.C) c_int, ?*anyopaque) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const fn (?*anyopaque) callconv(.C) c_int, ?*anyopaque) callconv(.C) ?*anyopaque),
    complete: ?*const fn ([*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8) callconv(.C) c_int),
    complete16: ?*const fn (?*const anyopaque) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*const anyopaque) callconv(.C) c_int),
    create_collation: ?*const fn (?*sqlite3, [*c]const u8, c_int, ?*anyopaque, ?*const fn (?*anyopaque, c_int, ?*const anyopaque, c_int, ?*const anyopaque) callconv(.C) c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, c_int, ?*anyopaque, ?*const fn (?*anyopaque, c_int, ?*const anyopaque, c_int, ?*const anyopaque) callconv(.C) c_int) callconv(.C) c_int),
    create_collation16: ?*const fn (?*sqlite3, ?*const anyopaque, c_int, ?*anyopaque, ?*const fn (?*anyopaque, c_int, ?*const anyopaque, c_int, ?*const anyopaque) callconv(.C) c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const anyopaque, c_int, ?*anyopaque, ?*const fn (?*anyopaque, c_int, ?*const anyopaque, c_int, ?*const anyopaque) callconv(.C) c_int) callconv(.C) c_int),
    create_function: ?*const fn (?*sqlite3, [*c]const u8, c_int, c_int, ?*anyopaque, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, c_int, c_int, ?*anyopaque, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context) callconv(.C) void) callconv(.C) c_int),
    create_function16: ?*const fn (?*sqlite3, ?*const anyopaque, c_int, c_int, ?*anyopaque, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const anyopaque, c_int, c_int, ?*anyopaque, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context) callconv(.C) void) callconv(.C) c_int),
    create_module: ?*const fn (?*sqlite3, [*c]const u8, [*c]const sqlite3_module, ?*anyopaque) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, [*c]const sqlite3_module, ?*anyopaque) callconv(.C) c_int),
    data_count: ?*const fn (?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) c_int),
    db_handle: ?*const fn (?*sqlite3_stmt) callconv(.C) ?*sqlite3 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) ?*sqlite3),
    declare_vtab: ?*const fn (?*sqlite3, [*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8) callconv(.C) c_int),
    enable_shared_cache: ?*const fn (c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (c_int) callconv(.C) c_int),
    errcode: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    errmsg: ?*const fn (?*sqlite3) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) [*c]const u8),
    errmsg16: ?*const fn (?*sqlite3) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) ?*const anyopaque),
    exec: ?*const fn (?*sqlite3, [*c]const u8, sqlite3_callback, ?*anyopaque, [*c][*c]u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, sqlite3_callback, ?*anyopaque, [*c][*c]u8) callconv(.C) c_int),
    expired: ?*const fn (?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) c_int),
    finalize: ?*const fn (?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) c_int),
    free: ?*const fn (?*anyopaque) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*anyopaque) callconv(.C) void),
    free_table: ?*const fn ([*c][*c]u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn ([*c][*c]u8) callconv(.C) void),
    get_autocommit: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    get_auxdata: ?*const fn (?*sqlite3_context, c_int) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, c_int) callconv(.C) ?*anyopaque),
    get_table: ?*const fn (?*sqlite3, [*c]const u8, [*c][*c][*c]u8, [*c]c_int, [*c]c_int, [*c][*c]u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, [*c][*c][*c]u8, [*c]c_int, [*c]c_int, [*c][*c]u8) callconv(.C) c_int),
    global_recover: ?*const fn () callconv(.C) c_int = @import("std").mem.zeroes(?*const fn () callconv(.C) c_int),
    interruptx: ?*const fn (?*sqlite3) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) void),
    last_insert_rowid: ?*const fn (?*sqlite3) callconv(.C) sqlite_int64 = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) sqlite_int64),
    libversion: ?*const fn () callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn () callconv(.C) [*c]const u8),
    libversion_number: ?*const fn () callconv(.C) c_int = @import("std").mem.zeroes(?*const fn () callconv(.C) c_int),
    malloc: ?*const fn (c_int) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (c_int) callconv(.C) ?*anyopaque),
    mprintf: ?*const fn ([*c]const u8, ...) callconv(.C) [*c]u8 = @import("std").mem.zeroes(?*const fn ([*c]const u8, ...) callconv(.C) [*c]u8),
    open: ?*const fn ([*c]const u8, [*c]?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]?*sqlite3) callconv(.C) c_int),
    open16: ?*const fn (?*const anyopaque, [*c]?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*const anyopaque, [*c]?*sqlite3) callconv(.C) c_int),
    prepare: ?*const fn (?*sqlite3, [*c]const u8, c_int, [*c]?*sqlite3_stmt, [*c][*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, c_int, [*c]?*sqlite3_stmt, [*c][*c]const u8) callconv(.C) c_int),
    prepare16: ?*const fn (?*sqlite3, ?*const anyopaque, c_int, [*c]?*sqlite3_stmt, [*c]?*const anyopaque) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const anyopaque, c_int, [*c]?*sqlite3_stmt, [*c]?*const anyopaque) callconv(.C) c_int),
    profile: ?*const fn (?*sqlite3, ?*const fn (?*anyopaque, [*c]const u8, sqlite_uint64) callconv(.C) void, ?*anyopaque) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const fn (?*anyopaque, [*c]const u8, sqlite_uint64) callconv(.C) void, ?*anyopaque) callconv(.C) ?*anyopaque),
    progress_handler: ?*const fn (?*sqlite3, c_int, ?*const fn (?*anyopaque) callconv(.C) c_int, ?*anyopaque) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3, c_int, ?*const fn (?*anyopaque) callconv(.C) c_int, ?*anyopaque) callconv(.C) void),
    realloc: ?*const fn (?*anyopaque, c_int) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*anyopaque, c_int) callconv(.C) ?*anyopaque),
    reset: ?*const fn (?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) c_int),
    result_blob: ?*const fn (?*sqlite3_context, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void),
    result_double: ?*const fn (?*sqlite3_context, f64) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, f64) callconv(.C) void),
    result_error: ?*const fn (?*sqlite3_context, [*c]const u8, c_int) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, [*c]const u8, c_int) callconv(.C) void),
    result_error16: ?*const fn (?*sqlite3_context, ?*const anyopaque, c_int) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, ?*const anyopaque, c_int) callconv(.C) void),
    result_int: ?*const fn (?*sqlite3_context, c_int) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, c_int) callconv(.C) void),
    result_int64: ?*const fn (?*sqlite3_context, sqlite_int64) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, sqlite_int64) callconv(.C) void),
    result_null: ?*const fn (?*sqlite3_context) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context) callconv(.C) void),
    result_text: ?*const fn (?*sqlite3_context, [*c]const u8, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, [*c]const u8, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void),
    result_text16: ?*const fn (?*sqlite3_context, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void),
    result_text16be: ?*const fn (?*sqlite3_context, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void),
    result_text16le: ?*const fn (?*sqlite3_context, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, ?*const anyopaque, c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void),
    result_value: ?*const fn (?*sqlite3_context, ?*sqlite3_value) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, ?*sqlite3_value) callconv(.C) void),
    rollback_hook: ?*const fn (?*sqlite3, ?*const fn (?*anyopaque) callconv(.C) void, ?*anyopaque) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const fn (?*anyopaque) callconv(.C) void, ?*anyopaque) callconv(.C) ?*anyopaque),
    set_authorizer: ?*const fn (?*sqlite3, ?*const fn (?*anyopaque, c_int, [*c]const u8, [*c]const u8, [*c]const u8, [*c]const u8) callconv(.C) c_int, ?*anyopaque) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const fn (?*anyopaque, c_int, [*c]const u8, [*c]const u8, [*c]const u8, [*c]const u8) callconv(.C) c_int, ?*anyopaque) callconv(.C) c_int),
    set_auxdata: ?*const fn (?*sqlite3_context, c_int, ?*anyopaque, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, c_int, ?*anyopaque, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void),
    xsnprintf: ?*const fn (c_int, [*c]u8, [*c]const u8, ...) callconv(.C) [*c]u8 = @import("std").mem.zeroes(?*const fn (c_int, [*c]u8, [*c]const u8, ...) callconv(.C) [*c]u8),
    step: ?*const fn (?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) c_int),
    table_column_metadata: ?*const fn (?*sqlite3, [*c]const u8, [*c]const u8, [*c]const u8, [*c][*c]const u8, [*c][*c]const u8, [*c]c_int, [*c]c_int, [*c]c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, [*c]const u8, [*c]const u8, [*c][*c]const u8, [*c][*c]const u8, [*c]c_int, [*c]c_int, [*c]c_int) callconv(.C) c_int),
    thread_cleanup: ?*const fn () callconv(.C) void = @import("std").mem.zeroes(?*const fn () callconv(.C) void),
    total_changes: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    trace: ?*const fn (?*sqlite3, ?*const fn (?*anyopaque, [*c]const u8) callconv(.C) void, ?*anyopaque) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const fn (?*anyopaque, [*c]const u8) callconv(.C) void, ?*anyopaque) callconv(.C) ?*anyopaque),
    transfer_bindings: ?*const fn (?*sqlite3_stmt, ?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, ?*sqlite3_stmt) callconv(.C) c_int),
    update_hook: ?*const fn (?*sqlite3, ?*const fn (?*anyopaque, c_int, [*c]const u8, [*c]const u8, sqlite_int64) callconv(.C) void, ?*anyopaque) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const fn (?*anyopaque, c_int, [*c]const u8, [*c]const u8, sqlite_int64) callconv(.C) void, ?*anyopaque) callconv(.C) ?*anyopaque),
    user_data: ?*const fn (?*sqlite3_context) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_context) callconv(.C) ?*anyopaque),
    value_blob: ?*const fn (?*sqlite3_value) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) ?*const anyopaque),
    value_bytes: ?*const fn (?*sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) c_int),
    value_bytes16: ?*const fn (?*sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) c_int),
    value_double: ?*const fn (?*sqlite3_value) callconv(.C) f64 = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) f64),
    value_int: ?*const fn (?*sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) c_int),
    value_int64: ?*const fn (?*sqlite3_value) callconv(.C) sqlite_int64 = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) sqlite_int64),
    value_numeric_type: ?*const fn (?*sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) c_int),
    value_text: ?*const fn (?*sqlite3_value) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) [*c]const u8),
    value_text16: ?*const fn (?*sqlite3_value) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) ?*const anyopaque),
    value_text16be: ?*const fn (?*sqlite3_value) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) ?*const anyopaque),
    value_text16le: ?*const fn (?*sqlite3_value) callconv(.C) ?*const anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) ?*const anyopaque),
    value_type: ?*const fn (?*sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) c_int),
    vmprintf: ?*const fn ([*c]const u8, [*c]struct___va_list_tag_1) callconv(.C) [*c]u8 = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]struct___va_list_tag_1) callconv(.C) [*c]u8),
    overload_function: ?*const fn (?*sqlite3, [*c]const u8, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, c_int) callconv(.C) c_int),
    prepare_v2: ?*const fn (?*sqlite3, [*c]const u8, c_int, [*c]?*sqlite3_stmt, [*c][*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, c_int, [*c]?*sqlite3_stmt, [*c][*c]const u8) callconv(.C) c_int),
    prepare16_v2: ?*const fn (?*sqlite3, ?*const anyopaque, c_int, [*c]?*sqlite3_stmt, [*c]?*const anyopaque) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const anyopaque, c_int, [*c]?*sqlite3_stmt, [*c]?*const anyopaque) callconv(.C) c_int),
    clear_bindings: ?*const fn (?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) c_int),
    create_module_v2: ?*const fn (?*sqlite3, [*c]const u8, [*c]const sqlite3_module, ?*anyopaque, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, [*c]const sqlite3_module, ?*anyopaque, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int),
    bind_zeroblob: ?*const fn (?*sqlite3_stmt, c_int, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, c_int) callconv(.C) c_int),
    blob_bytes: ?*const fn (?*sqlite3_blob) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_blob) callconv(.C) c_int),
    blob_close: ?*const fn (?*sqlite3_blob) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_blob) callconv(.C) c_int),
    blob_open: ?*const fn (?*sqlite3, [*c]const u8, [*c]const u8, [*c]const u8, sqlite3_int64, c_int, [*c]?*sqlite3_blob) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, [*c]const u8, [*c]const u8, sqlite3_int64, c_int, [*c]?*sqlite3_blob) callconv(.C) c_int),
    blob_read: ?*const fn (?*sqlite3_blob, ?*anyopaque, c_int, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_blob, ?*anyopaque, c_int, c_int) callconv(.C) c_int),
    blob_write: ?*const fn (?*sqlite3_blob, ?*const anyopaque, c_int, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_blob, ?*const anyopaque, c_int, c_int) callconv(.C) c_int),
    create_collation_v2: ?*const fn (?*sqlite3, [*c]const u8, c_int, ?*anyopaque, ?*const fn (?*anyopaque, c_int, ?*const anyopaque, c_int, ?*const anyopaque) callconv(.C) c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, c_int, ?*anyopaque, ?*const fn (?*anyopaque, c_int, ?*const anyopaque, c_int, ?*const anyopaque) callconv(.C) c_int, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int),
    file_control: ?*const fn (?*sqlite3, [*c]const u8, c_int, ?*anyopaque) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, c_int, ?*anyopaque) callconv(.C) c_int),
    memory_highwater: ?*const fn (c_int) callconv(.C) sqlite3_int64 = @import("std").mem.zeroes(?*const fn (c_int) callconv(.C) sqlite3_int64),
    memory_used: ?*const fn () callconv(.C) sqlite3_int64 = @import("std").mem.zeroes(?*const fn () callconv(.C) sqlite3_int64),
    mutex_alloc: ?*const fn (c_int) callconv(.C) ?*sqlite3_mutex = @import("std").mem.zeroes(?*const fn (c_int) callconv(.C) ?*sqlite3_mutex),
    mutex_enter: ?*const fn (?*sqlite3_mutex) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_mutex) callconv(.C) void),
    mutex_free: ?*const fn (?*sqlite3_mutex) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_mutex) callconv(.C) void),
    mutex_leave: ?*const fn (?*sqlite3_mutex) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_mutex) callconv(.C) void),
    mutex_try: ?*const fn (?*sqlite3_mutex) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_mutex) callconv(.C) c_int),
    open_v2: ?*const fn ([*c]const u8, [*c]?*sqlite3, c_int, [*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]?*sqlite3, c_int, [*c]const u8) callconv(.C) c_int),
    release_memory: ?*const fn (c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (c_int) callconv(.C) c_int),
    result_error_nomem: ?*const fn (?*sqlite3_context) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context) callconv(.C) void),
    result_error_toobig: ?*const fn (?*sqlite3_context) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context) callconv(.C) void),
    sleep: ?*const fn (c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (c_int) callconv(.C) c_int),
    soft_heap_limit: ?*const fn (c_int) callconv(.C) void = @import("std").mem.zeroes(?*const fn (c_int) callconv(.C) void),
    vfs_find: ?*const fn ([*c]const u8) callconv(.C) [*c]sqlite3_vfs = @import("std").mem.zeroes(?*const fn ([*c]const u8) callconv(.C) [*c]sqlite3_vfs),
    vfs_register: ?*const fn ([*c]sqlite3_vfs, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]sqlite3_vfs, c_int) callconv(.C) c_int),
    vfs_unregister: ?*const fn ([*c]sqlite3_vfs) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]sqlite3_vfs) callconv(.C) c_int),
    xthreadsafe: ?*const fn () callconv(.C) c_int = @import("std").mem.zeroes(?*const fn () callconv(.C) c_int),
    result_zeroblob: ?*const fn (?*sqlite3_context, c_int) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, c_int) callconv(.C) void),
    result_error_code: ?*const fn (?*sqlite3_context, c_int) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, c_int) callconv(.C) void),
    test_control: ?*const fn (c_int, ...) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (c_int, ...) callconv(.C) c_int),
    randomness: ?*const fn (c_int, ?*anyopaque) callconv(.C) void = @import("std").mem.zeroes(?*const fn (c_int, ?*anyopaque) callconv(.C) void),
    context_db_handle: ?*const fn (?*sqlite3_context) callconv(.C) ?*sqlite3 = @import("std").mem.zeroes(?*const fn (?*sqlite3_context) callconv(.C) ?*sqlite3),
    extended_result_codes: ?*const fn (?*sqlite3, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, c_int) callconv(.C) c_int),
    limit: ?*const fn (?*sqlite3, c_int, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, c_int, c_int) callconv(.C) c_int),
    next_stmt: ?*const fn (?*sqlite3, ?*sqlite3_stmt) callconv(.C) ?*sqlite3_stmt = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*sqlite3_stmt) callconv(.C) ?*sqlite3_stmt),
    sql: ?*const fn (?*sqlite3_stmt) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) [*c]const u8),
    status: ?*const fn (c_int, [*c]c_int, [*c]c_int, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (c_int, [*c]c_int, [*c]c_int, c_int) callconv(.C) c_int),
    backup_finish: ?*const fn (?*sqlite3_backup) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_backup) callconv(.C) c_int),
    backup_init: ?*const fn (?*sqlite3, [*c]const u8, ?*sqlite3, [*c]const u8) callconv(.C) ?*sqlite3_backup = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, ?*sqlite3, [*c]const u8) callconv(.C) ?*sqlite3_backup),
    backup_pagecount: ?*const fn (?*sqlite3_backup) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_backup) callconv(.C) c_int),
    backup_remaining: ?*const fn (?*sqlite3_backup) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_backup) callconv(.C) c_int),
    backup_step: ?*const fn (?*sqlite3_backup, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_backup, c_int) callconv(.C) c_int),
    compileoption_get: ?*const fn (c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (c_int) callconv(.C) [*c]const u8),
    compileoption_used: ?*const fn ([*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8) callconv(.C) c_int),
    create_function_v2: ?*const fn (?*sqlite3, [*c]const u8, c_int, c_int, ?*anyopaque, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context) callconv(.C) void, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, c_int, c_int, ?*anyopaque, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context) callconv(.C) void, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int),
    db_config: ?*const fn (?*sqlite3, c_int, ...) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, c_int, ...) callconv(.C) c_int),
    db_mutex: ?*const fn (?*sqlite3) callconv(.C) ?*sqlite3_mutex = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) ?*sqlite3_mutex),
    db_status: ?*const fn (?*sqlite3, c_int, [*c]c_int, [*c]c_int, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, c_int, [*c]c_int, [*c]c_int, c_int) callconv(.C) c_int),
    extended_errcode: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    log: ?*const fn (c_int, [*c]const u8, ...) callconv(.C) void = @import("std").mem.zeroes(?*const fn (c_int, [*c]const u8, ...) callconv(.C) void),
    soft_heap_limit64: ?*const fn (sqlite3_int64) callconv(.C) sqlite3_int64 = @import("std").mem.zeroes(?*const fn (sqlite3_int64) callconv(.C) sqlite3_int64),
    sourceid: ?*const fn () callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn () callconv(.C) [*c]const u8),
    stmt_status: ?*const fn (?*sqlite3_stmt, c_int, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, c_int) callconv(.C) c_int),
    strnicmp: ?*const fn ([*c]const u8, [*c]const u8, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const u8, c_int) callconv(.C) c_int),
    unlock_notify: ?*const fn (?*sqlite3, ?*const fn ([*c]?*anyopaque, c_int) callconv(.C) void, ?*anyopaque) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const fn ([*c]?*anyopaque, c_int) callconv(.C) void, ?*anyopaque) callconv(.C) c_int),
    wal_autocheckpoint: ?*const fn (?*sqlite3, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, c_int) callconv(.C) c_int),
    wal_checkpoint: ?*const fn (?*sqlite3, [*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8) callconv(.C) c_int),
    wal_hook: ?*const fn (?*sqlite3, ?*const fn (?*anyopaque, ?*sqlite3, [*c]const u8, c_int) callconv(.C) c_int, ?*anyopaque) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const fn (?*anyopaque, ?*sqlite3, [*c]const u8, c_int) callconv(.C) c_int, ?*anyopaque) callconv(.C) ?*anyopaque),
    blob_reopen: ?*const fn (?*sqlite3_blob, sqlite3_int64) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_blob, sqlite3_int64) callconv(.C) c_int),
    vtab_config: ?*const fn (?*sqlite3, c_int, ...) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, c_int, ...) callconv(.C) c_int),
    vtab_on_conflict: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    close_v2: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    db_filename: ?*const fn (?*sqlite3, [*c]const u8) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8) callconv(.C) [*c]const u8),
    db_readonly: ?*const fn (?*sqlite3, [*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8) callconv(.C) c_int),
    db_release_memory: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    errstr: ?*const fn (c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (c_int) callconv(.C) [*c]const u8),
    stmt_busy: ?*const fn (?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) c_int),
    stmt_readonly: ?*const fn (?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) c_int),
    stricmp: ?*const fn ([*c]const u8, [*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const u8) callconv(.C) c_int),
    uri_boolean: ?*const fn ([*c]const u8, [*c]const u8, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const u8, c_int) callconv(.C) c_int),
    uri_int64: ?*const fn ([*c]const u8, [*c]const u8, sqlite3_int64) callconv(.C) sqlite3_int64 = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const u8, sqlite3_int64) callconv(.C) sqlite3_int64),
    uri_parameter: ?*const fn ([*c]const u8, [*c]const u8) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const u8) callconv(.C) [*c]const u8),
    xvsnprintf: ?*const fn (c_int, [*c]u8, [*c]const u8, [*c]struct___va_list_tag_1) callconv(.C) [*c]u8 = @import("std").mem.zeroes(?*const fn (c_int, [*c]u8, [*c]const u8, [*c]struct___va_list_tag_1) callconv(.C) [*c]u8),
    wal_checkpoint_v2: ?*const fn (?*sqlite3, [*c]const u8, c_int, [*c]c_int, [*c]c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, c_int, [*c]c_int, [*c]c_int) callconv(.C) c_int),
    auto_extension: ?*const fn (?*const fn () callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*const fn () callconv(.C) void) callconv(.C) c_int),
    bind_blob64: ?*const fn (?*sqlite3_stmt, c_int, ?*const anyopaque, sqlite3_uint64, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, ?*const anyopaque, sqlite3_uint64, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int),
    bind_text64: ?*const fn (?*sqlite3_stmt, c_int, [*c]const u8, sqlite3_uint64, ?*const fn (?*anyopaque) callconv(.C) void, u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, [*c]const u8, sqlite3_uint64, ?*const fn (?*anyopaque) callconv(.C) void, u8) callconv(.C) c_int),
    cancel_auto_extension: ?*const fn (?*const fn () callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*const fn () callconv(.C) void) callconv(.C) c_int),
    load_extension: ?*const fn (?*sqlite3, [*c]const u8, [*c]const u8, [*c][*c]u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, [*c]const u8, [*c][*c]u8) callconv(.C) c_int),
    malloc64: ?*const fn (sqlite3_uint64) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (sqlite3_uint64) callconv(.C) ?*anyopaque),
    msize: ?*const fn (?*anyopaque) callconv(.C) sqlite3_uint64 = @import("std").mem.zeroes(?*const fn (?*anyopaque) callconv(.C) sqlite3_uint64),
    realloc64: ?*const fn (?*anyopaque, sqlite3_uint64) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*anyopaque, sqlite3_uint64) callconv(.C) ?*anyopaque),
    reset_auto_extension: ?*const fn () callconv(.C) void = @import("std").mem.zeroes(?*const fn () callconv(.C) void),
    result_blob64: ?*const fn (?*sqlite3_context, ?*const anyopaque, sqlite3_uint64, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, ?*const anyopaque, sqlite3_uint64, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void),
    result_text64: ?*const fn (?*sqlite3_context, [*c]const u8, sqlite3_uint64, ?*const fn (?*anyopaque) callconv(.C) void, u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, [*c]const u8, sqlite3_uint64, ?*const fn (?*anyopaque) callconv(.C) void, u8) callconv(.C) void),
    strglob: ?*const fn ([*c]const u8, [*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const u8) callconv(.C) c_int),
    value_dup: ?*const fn (?*const sqlite3_value) callconv(.C) ?*sqlite3_value = @import("std").mem.zeroes(?*const fn (?*const sqlite3_value) callconv(.C) ?*sqlite3_value),
    value_free: ?*const fn (?*sqlite3_value) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) void),
    result_zeroblob64: ?*const fn (?*sqlite3_context, sqlite3_uint64) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, sqlite3_uint64) callconv(.C) c_int),
    bind_zeroblob64: ?*const fn (?*sqlite3_stmt, c_int, sqlite3_uint64) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, sqlite3_uint64) callconv(.C) c_int),
    value_subtype: ?*const fn (?*sqlite3_value) callconv(.C) c_uint = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) c_uint),
    result_subtype: ?*const fn (?*sqlite3_context, c_uint) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, c_uint) callconv(.C) void),
    status64: ?*const fn (c_int, [*c]sqlite3_int64, [*c]sqlite3_int64, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (c_int, [*c]sqlite3_int64, [*c]sqlite3_int64, c_int) callconv(.C) c_int),
    strlike: ?*const fn ([*c]const u8, [*c]const u8, c_uint) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const u8, c_uint) callconv(.C) c_int),
    db_cacheflush: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    system_errno: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    trace_v2: ?*const fn (?*sqlite3, c_uint, ?*const fn (c_uint, ?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.C) c_int, ?*anyopaque) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, c_uint, ?*const fn (c_uint, ?*anyopaque, ?*anyopaque, ?*anyopaque) callconv(.C) c_int, ?*anyopaque) callconv(.C) c_int),
    expanded_sql: ?*const fn (?*sqlite3_stmt) callconv(.C) [*c]u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) [*c]u8),
    set_last_insert_rowid: ?*const fn (?*sqlite3, sqlite3_int64) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3, sqlite3_int64) callconv(.C) void),
    prepare_v3: ?*const fn (?*sqlite3, [*c]const u8, c_int, c_uint, [*c]?*sqlite3_stmt, [*c][*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, c_int, c_uint, [*c]?*sqlite3_stmt, [*c][*c]const u8) callconv(.C) c_int),
    prepare16_v3: ?*const fn (?*sqlite3, ?*const anyopaque, c_int, c_uint, [*c]?*sqlite3_stmt, [*c]?*const anyopaque) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const anyopaque, c_int, c_uint, [*c]?*sqlite3_stmt, [*c]?*const anyopaque) callconv(.C) c_int),
    bind_pointer: ?*const fn (?*sqlite3_stmt, c_int, ?*anyopaque, [*c]const u8, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int, ?*anyopaque, [*c]const u8, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int),
    result_pointer: ?*const fn (?*sqlite3_context, ?*anyopaque, [*c]const u8, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_context, ?*anyopaque, [*c]const u8, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) void),
    value_pointer: ?*const fn (?*sqlite3_value, [*c]const u8) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3_value, [*c]const u8) callconv(.C) ?*anyopaque),
    vtab_nochange: ?*const fn (?*sqlite3_context) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_context) callconv(.C) c_int),
    value_nochange: ?*const fn (?*sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) c_int),
    vtab_collation: ?*const fn ([*c]sqlite3_index_info, c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn ([*c]sqlite3_index_info, c_int) callconv(.C) [*c]const u8),
    keyword_count: ?*const fn () callconv(.C) c_int = @import("std").mem.zeroes(?*const fn () callconv(.C) c_int),
    keyword_name: ?*const fn (c_int, [*c][*c]const u8, [*c]c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (c_int, [*c][*c]const u8, [*c]c_int) callconv(.C) c_int),
    keyword_check: ?*const fn ([*c]const u8, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]const u8, c_int) callconv(.C) c_int),
    str_new: ?*const fn (?*sqlite3) callconv(.C) ?*sqlite3_str = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) ?*sqlite3_str),
    str_finish: ?*const fn (?*sqlite3_str) callconv(.C) [*c]u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_str) callconv(.C) [*c]u8),
    str_appendf: ?*const fn (?*sqlite3_str, [*c]const u8, ...) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_str, [*c]const u8, ...) callconv(.C) void),
    str_vappendf: ?*const fn (?*sqlite3_str, [*c]const u8, [*c]struct___va_list_tag_1) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_str, [*c]const u8, [*c]struct___va_list_tag_1) callconv(.C) void),
    str_append: ?*const fn (?*sqlite3_str, [*c]const u8, c_int) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_str, [*c]const u8, c_int) callconv(.C) void),
    str_appendall: ?*const fn (?*sqlite3_str, [*c]const u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_str, [*c]const u8) callconv(.C) void),
    str_appendchar: ?*const fn (?*sqlite3_str, c_int, u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_str, c_int, u8) callconv(.C) void),
    str_reset: ?*const fn (?*sqlite3_str) callconv(.C) void = @import("std").mem.zeroes(?*const fn (?*sqlite3_str) callconv(.C) void),
    str_errcode: ?*const fn (?*sqlite3_str) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_str) callconv(.C) c_int),
    str_length: ?*const fn (?*sqlite3_str) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_str) callconv(.C) c_int),
    str_value: ?*const fn (?*sqlite3_str) callconv(.C) [*c]u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_str) callconv(.C) [*c]u8),
    create_window_function: ?*const fn (?*sqlite3, [*c]const u8, c_int, c_int, ?*anyopaque, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context) callconv(.C) void, ?*const fn (?*sqlite3_context) callconv(.C) void, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, c_int, c_int, ?*anyopaque, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*sqlite3_context) callconv(.C) void, ?*const fn (?*sqlite3_context) callconv(.C) void, ?*const fn (?*sqlite3_context, c_int, [*c]?*sqlite3_value) callconv(.C) void, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int),
    normalized_sql: ?*const fn (?*sqlite3_stmt) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) [*c]const u8),
    stmt_isexplain: ?*const fn (?*sqlite3_stmt) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt) callconv(.C) c_int),
    value_frombind: ?*const fn (?*sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) c_int),
    drop_modules: ?*const fn (?*sqlite3, [*c][*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c][*c]const u8) callconv(.C) c_int),
    hard_heap_limit64: ?*const fn (sqlite3_int64) callconv(.C) sqlite3_int64 = @import("std").mem.zeroes(?*const fn (sqlite3_int64) callconv(.C) sqlite3_int64),
    uri_key: ?*const fn ([*c]const u8, c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn ([*c]const u8, c_int) callconv(.C) [*c]const u8),
    filename_database: ?*const fn ([*c]const u8) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn ([*c]const u8) callconv(.C) [*c]const u8),
    filename_journal: ?*const fn ([*c]const u8) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn ([*c]const u8) callconv(.C) [*c]const u8),
    filename_wal: ?*const fn ([*c]const u8) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn ([*c]const u8) callconv(.C) [*c]const u8),
    create_filename: ?*const fn ([*c]const u8, [*c]const u8, [*c]const u8, c_int, [*c][*c]const u8) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn ([*c]const u8, [*c]const u8, [*c]const u8, c_int, [*c][*c]const u8) callconv(.C) [*c]const u8),
    free_filename: ?*const fn ([*c]const u8) callconv(.C) void = @import("std").mem.zeroes(?*const fn ([*c]const u8) callconv(.C) void),
    database_file_object: ?*const fn ([*c]const u8) callconv(.C) [*c]sqlite3_file = @import("std").mem.zeroes(?*const fn ([*c]const u8) callconv(.C) [*c]sqlite3_file),
    txn_state: ?*const fn (?*sqlite3, [*c]const u8) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8) callconv(.C) c_int),
    changes64: ?*const fn (?*sqlite3) callconv(.C) sqlite3_int64 = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) sqlite3_int64),
    total_changes64: ?*const fn (?*sqlite3) callconv(.C) sqlite3_int64 = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) sqlite3_int64),
    autovacuum_pages: ?*const fn (?*sqlite3, ?*const fn (?*anyopaque, [*c]const u8, c_uint, c_uint, c_uint) callconv(.C) c_uint, ?*anyopaque, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, ?*const fn (?*anyopaque, [*c]const u8, c_uint, c_uint, c_uint) callconv(.C) c_uint, ?*anyopaque, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int),
    error_offset: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    vtab_rhs_value: ?*const fn ([*c]sqlite3_index_info, c_int, [*c]?*sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]sqlite3_index_info, c_int, [*c]?*sqlite3_value) callconv(.C) c_int),
    vtab_distinct: ?*const fn ([*c]sqlite3_index_info) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]sqlite3_index_info) callconv(.C) c_int),
    vtab_in: ?*const fn ([*c]sqlite3_index_info, c_int, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn ([*c]sqlite3_index_info, c_int, c_int) callconv(.C) c_int),
    vtab_in_first: ?*const fn (?*sqlite3_value, [*c]?*sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_value, [*c]?*sqlite3_value) callconv(.C) c_int),
    vtab_in_next: ?*const fn (?*sqlite3_value, [*c]?*sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_value, [*c]?*sqlite3_value) callconv(.C) c_int),
    deserialize: ?*const fn (?*sqlite3, [*c]const u8, [*c]u8, sqlite3_int64, sqlite3_int64, c_uint) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, [*c]u8, sqlite3_int64, sqlite3_int64, c_uint) callconv(.C) c_int),
    serialize: ?*const fn (?*sqlite3, [*c]const u8, [*c]sqlite3_int64, c_uint) callconv(.C) [*c]u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, [*c]sqlite3_int64, c_uint) callconv(.C) [*c]u8),
    db_name: ?*const fn (?*sqlite3, c_int) callconv(.C) [*c]const u8 = @import("std").mem.zeroes(?*const fn (?*sqlite3, c_int) callconv(.C) [*c]const u8),
    value_encoding: ?*const fn (?*sqlite3_value) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_value) callconv(.C) c_int),
    is_interrupted: ?*const fn (?*sqlite3) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3) callconv(.C) c_int),
    stmt_explain: ?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3_stmt, c_int) callconv(.C) c_int),
    get_clientdata: ?*const fn (?*sqlite3, [*c]const u8) callconv(.C) ?*anyopaque = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8) callconv(.C) ?*anyopaque),
    set_clientdata: ?*const fn (?*sqlite3, [*c]const u8, ?*anyopaque, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int = @import("std").mem.zeroes(?*const fn (?*sqlite3, [*c]const u8, ?*anyopaque, ?*const fn (?*anyopaque) callconv(.C) void) callconv(.C) c_int),
};
...
pub const sqlite3_loadext_entry = ?*const fn (?*sqlite3, [*c][*c]u8, [*c]const sqlite3_api_routines) callconv(.C) c_int;
...
// /home/tetratrux/.cache/zig/p/122019ea6e071dbd932c3e51d9631d99f007240e3e08d5436a1da20ad088343ca4a7/c/loadable-ext-sqlite3.h:72:10
...
pub const SQLITE_EXTENSION_INIT1 = @compileError("unable to translate macro: undefined identifier `sqlite3_api`");
// /home/tetratrux/.cache/zig/p/122019ea6e071dbd932c3e51d9631d99f007240e3e08d5436a1da20ad088343ca4a7/c/loadable-ext-sqlite3ext.h:434:10
pub const SQLITE_EXTENSION_INIT2 = @compileError("unable to translate macro: undefined identifier `sqlite3_api`");
// /home/tetratrux/.cache/zig/p/122019ea6e071dbd932c3e51d9631d99f007240e3e08d5436a1da20ad088343ca4a7/c/loadable-ext-sqlite3ext.h:435:10
pub const SQLITE_EXTENSION_INIT3 = @compileError("unable to translate macro: undefined identifier `sqlite3_api`");
// /home/tetratrux/.cache/zig/p/122019ea6e071dbd932c3e51d9631d99f007240e3e08d5436a1da20ad088343ca4a7/c/loadable-ext-sqlite3ext.h:436:10
